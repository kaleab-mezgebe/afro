...
export default function BeautySalonsPage() {
  ...
  const loadBeautySalons = async () => {
    try {
      ...
      toast.error('Failed to load beauty salons');
      console.error('Beauty salons loading error:', error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <AdminLayout>
      <div className="page-content">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Beauty Salons Management</h1>
          <p className="text-gray-600">Manage all beauty salons and spa services on your platform</p>
        </div>
            ...
            <button className="w-full text-left p-4 bg-green-50 hover:bg-green-100 rounded-xl transition-colors border border-green-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Register a new beauty salon</p>
                </div>
              </div>
            </button>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">All Beauty Salons</h3>
